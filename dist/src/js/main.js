...
function stripFragmentTerminator(value) {
...
function makeRecordCard(title, body, meta, options = {}) {
  ...
  const displayBody = stripFragmentTerminator(body);
  if (displayBody) card.append(createElement("p", "", displayBody));
  return card;
}
...
function renderFeaturedGallery() {
  ...
  preview.append(row);
  preview.append(createElement("p", "", localizedFragmentField(exhibition, "descriptionEn", "descriptionCn")));
...
function renderWorks() {
  ...
  intro.textContent = localizedFragmentField(collection, "descriptionEn", "descriptionCn");
  ...
  caption.append(createElement("p", "", localizedFragmentField(featured, "importanceEn", "importanceCn")));
...
function makeArtworkButton(artwork, displayRecord, index, featured = false) {
  ...
  button.dataset.descriptionEn = stripFragmentTerminator(displayRecord.importanceEn || artwork.descriptionEn || "");
  button.dataset.descriptionCn = toTraditional(stripFragmentTerminator(displayRecord.importanceCn || artwork.descriptionCn || ""));
...
function renderHistoricalPortraitArchive() {
  ...
  records("historicalPortraitArchive").forEach((item) => {
    ...
    const captionText = localizedFragmentField(item, "captionEn", "captionCn");
...
function renderCollections() {
  ...
  heading.append(
    makeHeading(
      localized(intro.eyebrowEn, intro.eyebrowCn),
      localized(intro.titleEn, intro.titleCn),
      localizedFragment(intro.bodyEn, intro.bodyCn),
    ),
  );
  ...
  FEATURED_COLLECTIONS.records.forEach((item) => {
    ...
    const description = localizedFragmentField(item, "descriptionEn", "descriptionCn");
...
function renderSupport() {
  ...
  records("support").forEach((item) => {
    ...
    card.append(createElement("p", "", localizedFragment(item.descriptionEn, item.descriptionCn)));
    grid.append(card);
  });
...
function makeSupportSection(section) {
  ...
  if (section.footerEn || section.footerCn) {
    body.append(createElement("p", "support-detail-note", localizedFragment(section.footerEn, section.footerCn)));
  }
...
function renderFooter() {
  ...
  credit.append(createElement("p", "footer-museum-name", uiText("Gu Yuan Digital Museum", "古元數字美術館")));
  credit.append(
    createElement(
      "p",
      "footer-tagline",
